    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        ...
        <Card
          ...
          des="Let's collaborate to map out your application's goals, target audience, and key functionalities. We'll discuss aspects like user interface, functionality, and performance requirements. 🚀"
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
